...
Cái hiệu suất nó mang tính "trong tổng số G attempt gửi đi thì có bao nhiêu phần trăm là may mắn không bị collision".
\medskip
...
\noindent
\sidebox[-5cm]{Self-note:}{
Non-persistent khác với 1-persistent:
...
\noindent
\sidebox[-6cm]{Self-note: \textit{(Tóm tắt)}}{
\begin{itemize}
...
\noindent
\textbf{Tóm gọn MACA functioning}
\medskip
...
\sidebox[-2.5cm]{Note:}{
Một số time slot có thể được dành riêng cho broadcast traffic.
}

\sidebox{Self-note:}{
TDMA giống kiểu như chia nhau theo giờ, đến giờ của ai thì người đó dùng, dùng xong thì nhường cho người tiếp theo $\rightarrow$ tuy nhiên thì trong lúc dùng, mình được phép dùng hết công suất.
}
...
Đây là lý do tại sao nhiều chuẩn CRC (như CRC-16 hay CRC-32) đều có thừa số $(x+1)$ trong đa thức sinh của chúng.
}
