...
\noindent
$\rightarrow$ Là phương pháp điều chế cơ bản được sử dụng trong broadband.
...
$\rightarrow$ Cứ ví ASK như nhìn dãy đèn ở khoảng cách xa $\rightarrow$ đèn sáng (bit 1) và đèn tắt (bit 0) $\Rightarrow$ dễ thao tác, nhưng nếu trời bị sương mù dày đặc (nhiễu cao) $\rightarrow$ nhìn nhầm hoặc không thấy.
\medskip
...
\noindent
$\rightarrow$ Là phương pháp điều chế sử dụng trong broadband.
