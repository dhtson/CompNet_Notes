...
\noindent
\underline{Fact:} ở Nhật nó có có kênh 14, nghĩa là nó có tới tận 4 kênh không chồng lấn (1, 6, 11, 14).
\medskip
...
\noindent
\underline{Self-note:} (tổng quan về thuật toán RC4 và AES)
...
\noindent
\textbf{Công thức RC4:} $\text{Ciphertext} = \text{Plaintext} \oplus \text{Keystream}$
